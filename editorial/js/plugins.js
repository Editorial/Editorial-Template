	...
	if (matchMedia('screen and (min-width:640px)').matches) {
		(function(doc, script) {
			...
			if($('li.facebook').length) {
				...
				var params = 'send=false&amp;layout=button_count&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;height=20';
				$('li.facebook').html('<iframe src="http://www.facebook.com/plugins/like.php?href=' + url + '&amp;' + params +'" scrolling="no" frameborder="0" style="border:none;overflow:hidden;" allowTransparency="true"></iframe>');
			}
