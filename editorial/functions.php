...
class Editorial
{
    ...
    */
    ...
    public static function setup()
    {
        ...
        add_action('admin_init', array('Editorial','setUserMetaboxes'));
        add_action('after_setup_theme', array('Editorial','themeSetup'));
    ...
    /**
     * Get pages by post name
     *
     * @return mixed
     */
    public static function getPageByPostName($name)
    {
        $pages = get_pages();
    ...
    /**
     * Create colophon/masthead page.
     * (It used to be called colophon)
     *
     * @return void
     */
    public static function createColophonPage()
    {
        if (!Editorial::getPageByPostName('masthead'))
        {
            $page["post_type"] = 'page';
            $page["post_name"] = 'masthead';
            $page["post_title"] = 'Masthead';
            $page["post_content"] = '<h2>About</h2><p>Our masthead page</p>';
     ...
     * @return void
     */
    public static function showWelcomeNotice()
    {
     ...
     * @return void
     */
    public function setUserMetaboxes($user_id=NULL)
    {
    ...
    /**
     * Hide type url fields
     *
     * @return void
     */
    public function hideTypeUrlFields($html)
    {
    ...
    /**
     * Remove media upload library tab
     *
     * @return void
     */
    ...
    /**
     * Hide gallery settings div
     *
     * @return void
     */
    public function hideGalerySettingsDiv()
    {
        print <<<EOF
                <style type="text/css">
                    #gallery-settings *{
...
EOF;
    ...
    /**
     * Hide some attachment fields
     *
     * @return array
     */
    public function hideSomeAttachmentFields($form_fields, $post)
    {
